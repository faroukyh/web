                        ...
                        <table border=1 align='center'>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><?PHP echo $row['prenom_article']; ?></td>
                                    <td><img width="100" src="../front/images/<?PHP echo $row['image_article']; ?> "> </td>
                                    <td><?PHP echo $row['titre_article']; ?>$</td>
                                    <td><?PHP echo $row['text_article']; ?></td>
                                    ...
                                    <td>
                                        <a href="modifierarticles.php?id_article=<?PHP echo $row['id_article']; ?>"> Modifier </a>
                                    </td>
                                </tr>
                            <?PHP
                            }
